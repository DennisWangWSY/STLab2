...
public class WebDriverTest {
  ...
  public void setUp() throws Exception {
	System.setProperty("webdriver.firefox.bin", "D:/installed_softwares/FireFox/firefox.exe");
  ...
  public static Collection<Object[]> getData() throws IOException{
	  ...
	  CsvReader r= new CsvReader("E://本科课程学习//软件测试//Lab2//info.csv",',',Charset.forName("GBK"));
	  int count = 0;
	  while(r.readRecord()){
